...
class ProductionAgent:
    ...
    def __init__(self):
        ...
        self.primary_llm = ChatOpenAI(
            ...
            temperature=0,
            timeout=30,
            max_retries=0,   # we handle retires ourselves
    ...
    def _build_graph(self):
        ...
        def process_message(state: AgentState) -> dict:
            """try to process message with the primary model."""
            try:
        ...
        def route_after_process(state: AgentState) -> str:
            """Deside what to do after primary model attempt."""
        ...
        def route_after_fallback(state: AgentState) -> str:
            """Deside what to do after fallback model attempt."""
            if state.get("error") is None:
                return "done"
            else:
                return "error"
    ...
    def invoke(self, message: str) -> dict:
        """
        Invoke a agent with a user message.
